...
local CHANGELOG_LINES = {
    "|cffffcc00Banter v" .. ns.version .. " — Banter Styles, World PVP & Combat Recaps|r",
    "|cffffffffThe Comedy RP Engine for WoW Classic|r",
    "",
    "|cff00ff00Three banter styles, World PVP trash talk, and smarter event handling.|r",
    "",
    "|cffffcc00—— BANTER STYLES ——|r",
    "• NEW: Choose your playstyle — Social, Narrative, or Callouts",
    "• |cff00ccffSocial|r: Classic Banter — jokes, quips, and ambient chatter",
