...
local CHANGELOG_LINES = {
    "|cffffcc00Banter v" .. ns.version .. " — CC Callouts|r",
    "|cffffffffThe Comedy RP Engine for WoW Classic|r",
    "",
    "|cff00ff00Your group just got CC'd. Banter has opinions.|r",
    "",
    "|cffffcc00—— CC CALLOUTS ——|r",
    "• Banter now calls out EVERY CC and EVERY interrupt — no dice roll, just cooldown",
    "• CC callouts: spell name, duration, and dispel-shaming",
    "• Interrupt callouts: who kicked what spell",
    "• Fires everywhere — dungeons, raids, PvP, open world",
    "• Independent toggle: keep callouts ON even with banter OFF",
    "• /banter cc on|off or toggle in General settings",
    "• All 10 personas have unique callout lines",
    "",
