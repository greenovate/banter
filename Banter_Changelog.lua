...
local CHANGELOG_LINES = {
    "|cffffcc00Banter v" .. ns.version .. " — CC & Interrupt Callouts|r",
    "|cffffffffThe Comedy RP Engine for WoW Classic|r",
    "",
    "|cff00ff00CC'd? Interrupted? Banter has opinions.|r",
    "",
    "|cffffcc00—— CC CALLOUTS ——|r",
    "• Calls out EVERY CC and interrupt — no dice roll, just 5s cooldown",
    "• CC: announces spell name and shames available dispellers",
    "• Interrupts: announces who kicked what spell ({source} kicked {interrupted})",
    "• Fires everywhere — dungeons, raids, PvP, open world",
    "• Separate toggles: CC Callouts and Interrupt Callouts",
    "• Independent of main banter — works even with banter OFF",
    "• Only one Banter user calls out per event (leader-based dedup)",
    "• /banter cc on|off and /banter interrupts on|off",
    "• 23 interrupt lines per persona (was 8) — deep pools, no repeats",
    "• Expanded CC keyword detection — catches more stuns, roots, silences",
    "",
    "|cffffcc00—— SHOUT-OUT ——|r",
    "• Thanks to |cff00ccffRansomshox on Nightslayer|r for suggesting this feature!",
    "",
