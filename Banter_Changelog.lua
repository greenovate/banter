...
local CHANGELOG_LINES = {
    "|cffffcc00Banter v" .. ns.version .. " — Smarter Callouts|r",
    "|cffffffffClass-Driven Chat Engine for WoW Classic|r",
    "",
    "|cff00ff00Callouts now tell you WHO did WHAT to WHOM.|r",
    "",
    "|cffffcc00—— SPECIFIC CALLOUTS ——|r",
    "• Interrupt callouts now name the interrupter AND the spell kicked",
    "• CC callouts now name the victim AND the crowd control spell",
    "• All 10 personas rewritten with {source}, {victim}, {interrupted} tokens",
    "• Self-aware: addon uses 'I' when the callout is about YOU",
    "",
    "|cffffcc00—— CALLOUT DEDUP ——|r",
    "• Fixed callout spam when 3+ Banter users are in the same group",
    "• Added 5-second grace period after joining a group for peer discovery",
    "• Only one Banter user speaks per event — no more overlapping callouts",
    "",
    "|cffffcc00—— SELF-AWARE NAMES ——|r",
    "• Addon detects when it's talking about the player and says 'I' instead",
    "• Grammar fixup: 'I is dying' → 'I am dying', 'I has' → 'I have', etc.",
    "",
