...
scenes.CAPS = {
    ...
    INTERRUPT          = { partyMin = 0, partyMax = 1, raidMin = 0, raidMax = 1 },    INTERRUPT_SELF     = { partyMin = 0, partyMax = 0, raidMin = 0, raidMax = 0 },
    SHADOWFORM_DROP    = { partyMin = 0, partyMax = 1, raidMin = 0, raidMax = 1 },    PERIODIC_DAMAGE    = { partyMin = 0, partyMax = 2, raidMin = 0, raidMax = 2 },
