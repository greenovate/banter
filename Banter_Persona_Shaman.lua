...
statements = {
    ...
    SOLO_AMBIENT = {
        ...
        RARE = {
            ...
            { id="sha_solo_r04", weight=1, line="I placed all four totems in a clearing. Earth, Water, Fire, Air. For a moment, harmony. Then Fire tried to evaporate Water. Water retaliated. Earth took sides. Air watched. Twenty minutes of mediating. Standard totem deployment." },
            { id="sha_solo_r05", weight=1, line="Sometimes I wonder what normal people feel walking through nature. Do they hear Earth complaining about erosion? Does Fire whisper 'ignite' near a bush? Does Water narrate the clouds? Probably not. Must be quiet in there. Sounds boring." },
        },
        MYTHIC = {
            { id="sha_solo_m01", weight=1, line="A shaman is never truly alone. Earth offers opinions. Water narrates everything. Fire lobbies for destruction. Wind answers to no one. Four elements, one shaman, zero peace. Somewhere in the noise, I find my path. By accident." },
            { id="sha_solo_m02", weight=1, line="Just me and the elemental board of directors. Earth proposed 'stand still.' Water counter-proposed 'go with the flow.' Fire vetoed both: 'burn everything.' Wind abstained. I overruled them and kept walking. Shamanism. It's exhausting." },
        },
    },
